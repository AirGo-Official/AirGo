...
const (
	...
	// github
	AIRGO_GITHUB_API          = "https://api.github.com/repos/AirGo-Official/AirGo/releases/latest"
	AIRGO_GITHUB_DOWNLOAD_PRE = "https://github.com/AirGo-Official/AirGo/releases/download"

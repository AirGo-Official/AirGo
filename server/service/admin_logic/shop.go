...
// 查询全部商品
func (s *Shop) GetGoodsList() (*[]model.Goods, error) {
...
// 查询商品 by nodeID
func (s *Shop) FindGoodsByNodeID(nodeID int64) ([]model.Goods, error) {
	var node model.Node
...
// 新建商品
func (s *Shop) NewGoods(goods *model.Goods) error {
...
// 删除商品
func (s *Shop) DeleteGoods(goods *model.Goods) error {
	return global.DB.Transaction(func(tx *gorm.DB) error {

...
currentVersion=''
latestVersion=''
downloadPrefix='https://github.com/AirGo-Official/AirGo/releases/download/'
githubApi="https://api.github.com/repos/AirGo-Official/AirGo/releases/latest"
manageScript="https://raw.githubusercontent.com/AirGo-Official/AirGo/main/server/scripts/install.sh"

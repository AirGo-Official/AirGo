...
type Node struct {
	...
	NodeSpeedlimit  int64   `json:"node_speedlimit" gorm:"comment:节点限速,Mbps"`
	TrafficRate     float64 `json:"traffic_rate"    gorm:"comment:倍率"`
	NodeType        string  `json:"node_type"       gorm:"comment:节点类型 vless,vmess,trojan,shadowsocks"`
	IsSharedNode    bool    `json:"is_shared_node"  gorm:"comment:是否共享节点"`
	...
	Type            string  `json:"type"       gorm:"default:none;comment:伪装类型 ws,h2：无    tcp,kcp：none，http    mKCP,quic：none，srtp，utp，wechat-video，dtls，wireguard"`
	...
	//中转参数
	EnableTransfer  bool   `json:"enable_transfer"  gorm:"default:false;comment:是否启用中转"`

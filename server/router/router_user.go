...
import (
	"github.com/AirGo-Official/AirGo/api/user_api"
...
func (g *GinRouter) InitUserRouter(r *gin.RouterGroup) {
	...
	customerServiceRouter := customerRouter.Group("/customerService")
	{
		...
		customerServiceRouter.GET("/getCustomerService", user_api.GetCustomerService)
		customerServiceRouter.GET("/getSubscribeNodeList", user_api.GetSubscribeNodeList)
	}
	// menu

  ...
  <el-dialog v-model="state.isShowDialog" :title="state.title" width="80%" destroy-on-close align-center>
    <el-card shadow="hover" class="layout-padding-auto" style="height: 800px">
      <el-row :gutter="10" style="width: 768px">
        <el-col :span="18">
          <el-input v-model="nodeStoreData.nodeSharedData.value.newNodeSharedUrl.url" size="default"
          ></el-input>
        </el-col>
        <el-col :span="2">
      ...
      <el-table :data="nodeStoreData.nodeSharedData.value.nodeList.data" height="100%" stripe style="width: 100%;flex: 1;">

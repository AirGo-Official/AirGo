<template>
  <div>
    ...
    <div class="home-card-item">
      ...
      <el-table :data="state.statisticsData.thisMonthTraffic.data" height="100%" style="width: 100%;flex: 1;"
    ...
    <div class="home-card-item">
      ...
      <el-table :data="state.statisticsData.lastMonthTraffic.data" height="100%" style="width: 100%;flex: 1;" stripe
...
const defaultFieldParams = (start: string, end: string) => {
  state.queryParams.table_name = 'order'
  state.queryParams.field_params_list = [
...
function getMonthOrder(params?: object) {
  ...
  request(apiStoreData.adminApi.value.getOrderStatistics, state.queryParams).then((res) => {
    ...
    request(apiStoreData.adminApi.value.getNodeListWithTraffic, state.queryParams).then((res) => {

    ...
    <el-drawer title="布局配置" v-model="state.isDrawer" direction="rtl" destroy-on-close size="260px">
      <el-scrollbar class="layout-breadcrumb-seting-bar">
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt14">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-input v-model="getThemeConfig.wartermarkText" @change="onWartermarkChange" size="default"
                      style="width: 90px" @input="onWartermarkTextInput($event)"></el-input>
          </div>
        </div>
...
const onAddDarkChange = () => {
  ...
  if (getThemeConfig.value.isIsDark) body.setAttribute('data-system', 'dark');
  else body.setAttribute('data-system', '');
};
// 4、界面显示 --> 开启水印
...
const onResetConfigClick = () => {
  ...
  storesThemeConfig.updateThemeConfig(themeConfig.value)
  Local.clear();
